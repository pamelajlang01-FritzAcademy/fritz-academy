...
(function(){
  "use strict";
  const C=(id,x,scale,motion="idle",y=0)=>({id,x,scale,motion,y}),P=(kind,x,y,scale=1,motion="idle")=>({kind,x,y,scale,motion});
  const target=window.FritzLessonSceneSpecs||(window.FritzLessonSceneSpecs={});
  target["1-A"]={
    story:[
      {environment:"academy-front",caption:"Captain Fritz waits beside the Academy gate.",characters:[C("fritz",-.18,1)],props:[P("gate",.24,.03,1),P("flag",.34,-.19,.8,"sway")]},
      ...
      {environment:"academy-front",caption:"Captain Fritz waves and says, Hello!",characters:[C("fritz",-.14,1,"wave"),C("student",.22,.72)],props:[P("speech",.02,-.18,.75,"pop")]},
      {environment:"academy-front",caption:"The student says their name.",characters:[C("student",-.10,.72,"point"),C("fritz",.20,1)],props:[P("name-tag",.02,-.17,.8,"float")]},
    ...
    reader1:[
      {environment:"academy-front",caption:"Captain Fritz is at the gate.",characters:[C("fritz",-.12,1)],props:[P("gate",.25,.04,1)]},
      {environment:"academy-front",caption:"The student walks on the path.",characters:[C("student",-.05,.72,"walk")],props:[P("path",.15,.20,1)]},
      {environment:"academy-front",caption:"Captain Fritz waves.",characters:[C("fritz",-.12,1,"wave"),C("student",.22,.72)],props:[P("speech",.03,-.18,.7)]},
      {environment:"academy-front",caption:"The student says, Hello.",characters:[C("student",-.10,.72,"wave"),C("fritz",.20,1)],props:[P("speech",.02,-.18,.7)]},
    ...
    reader2:[
      ...
      {environment:"welcome-garden",caption:"Captain Fritz shows the garden plan.",characters:[C("fritz",-.16,1,"point"),C("student",.22,.72)],props:[P("map",.03,-.15,.8,"float")]},
