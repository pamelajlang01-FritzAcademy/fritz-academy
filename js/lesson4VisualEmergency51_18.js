/* Fritz Academy emergency class-safe Lesson 4 presentation */
(function(){
  'use strict';
  const REWARDS={
  ...
  function clear(){document.querySelectorAll('.l419-overlay,.l419-builder,.l418-overlay,.l418-builder,.l4p-overlay,.l4-scene-card').forEach(n=>n.remove());}
