/* Fritz Academy 52.8 — correct both song paths for tonight's fifth adventure */
(function(){
  'use strict';
  ...
  if(original.__lesson2ASongs52_8) return;
  ...
  CompletionEngine.prototype.showSummary.__lesson2ASongs52_8 = true;
  CompletionEngine.prototype.showSummary.__original = original;

  window.FRITZ_LESSON5_SONG_REPORT = {
    lessonId:'2-A',
    alphabetSong:'assets/alphabet-song-small.mp4',
    closingSong:'assets/welcome-song-small.mp4',
