...
(function(){
  ...
  IllustrationEngine.prototype.makeProp=function(spec,x,y,width,height,index){
    ...
    if(kind.includes("flower")||kind==="flowers"){
      [-28,0,28].forEach((dx,i)=>{rect(dx,15,4,34,0x3d8d45,0x3d8d45);circle(dx,0,12,[0xffcf47,0xff77a8,0x9a7bff][i],0xffffff);circle(dx,0,4,0x70451f,0x70451f);});
