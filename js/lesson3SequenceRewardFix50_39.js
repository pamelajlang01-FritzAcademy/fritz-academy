...
(function(){
  ...
  function applyLesson3(){
    ...
    lesson.story={
      ...
      pages:[
        ...
        {text:"Bear finds a blue hat beside the hedge.",image:"assets/bear.png"},
        {text:"Tony sees an insect near a sign marked I.",image:"assets/tony.png"},
  ...
  if(typeof LessonEngine!=="undefined"){
    const previousReward=LessonEngine.prototype.rewardPiece;
    ...
    const previousFeelingsIntro=LessonEngine.prototype.showFeelingsActivityIntro;
    LessonEngine.prototype.showFeelingsActivityIntro=function(){
      if(this.levelId==="1-C"){
        this.startStory();
        return;
      }
      return previousFeelingsIntro.apply(this,arguments);
    };

    const previousStartStory=LessonEngine.prototype.startStory;
    LessonEngine.prototype.startStory=function(){
      ...
      return previousStartStory.apply(this,arguments);
    };
  }
